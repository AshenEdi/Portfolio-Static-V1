  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                ...
                <a
                  ...
                  className={`p-3 rounded-full transition-all duration-300 ${
                    darkMode
                      ? 'bg-gray-800 text-white hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/25'
                      : 'bg-gray-200 text-gray-900 hover:bg-blue-500 hover:text-white hover:shadow-lg hover:shadow-blue-500/25'
                  }`}
                  aria-label="GitHub"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            ...
            <a
              href="#CV"
              download="CV.pdf"
              className={`px-4 py-2 rounded-full font-semibold whitespace-nowrap flex items-center gap-2 transition-all duration-300 backdrop-blur-md border ${
                darkMode
                  ? 'bg-white/10 border-white/20 text-white hover:bg-white/20 hover:border-white/30'
                  : 'bg-white/30 border-white/50 text-gray-900 hover:bg-white/40 hover:border-white/60'
              }`}
            >
      ...
      {showModal && selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4" onClick={() => setShowModal(false)}>
